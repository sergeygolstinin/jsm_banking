...
export const signUp = async ({ password, ...userData }: SignUpParams) => {
    ...
    try {
       ...
       newUserAccount = await account.create(
        ...
        if(!newUserAccount) throw new Error('Error Dwolla creating user')
...
client_user_id: user.$id
  ...
  }: createBankAccountProps)  => {if (!userId || !bankId || !accountId || !accessToken || !fundingSourceUrl || !shareableId) {
