...
const AuthForm = ({type}: {type: string}) => {
  ...
  return (
    <section className='auth-form'>
        ...
        <Link href='/' className='mb-30 cursor-pointer flex items-center gap-1'>
    <Image
    src='/icons/logo.svg'
    width={34}
    height={34}
...
<div className='flex flex-col gap-1 md:gap-3'>
  <h1 className='text-24 lg:text-36 font-semibold text-gray-900'>
    ...
    <footer className='flex justify-center gap'>
      <p className='text-14 font-normal text-gray-600h'>{type === 'sign-in'
